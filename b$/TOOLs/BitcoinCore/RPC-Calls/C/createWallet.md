...
Erstellt eine neue [Wallet](../../../../GLOSSAR/W/Wallet.md) mit dem von dir mitgegebenen Namen. Diese Wallet enthält dann natürlich noch keine Schlüssel und hat damit dann auch noch keine Funktion. 

## Syntax
    createwallet "wallet_name" (
        disable_private_keys blank 
        "passphrase" 
        avoid_reuse 
        descriptors 
        load_on_startup 
...
3. **blank** (boolean, optional, default=false): Creates a blank wallet. A blank wallet has no keys or HD seed. One can be set using *sethdseed*.
